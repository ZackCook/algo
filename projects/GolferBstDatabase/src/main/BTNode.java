...
public class BTNode<E> {
     ...
     * @param <CODE>initialLeft</CODE>  a reference to the left child of this new node--this reference may be null
     *                                  to indicate that there is no node after this new node.
     * @param <CODE>initialRight</CODE> a reference to the right child of this new node--this reference may be null
     *                                  to indicate that there is no node after this new node.
     ...
     * Copy a binary tree.
     *
     * @param <CODE>source</CODE> a reference to the root of a binary tree that will be copied (which may be
     ...
     *
     * @param <CODE>newData</CODE> the new data to place in this node
     *                             <dt><b>Postcondition:</b><dd>
     ...
     *
     * @param <CODE>newLeft</CODE> a reference to the node that should appear as the left child of this node
     ...
     *
     * @param <CODE>newLeft</CODE> a reference to the node that should appear as the right child of this node
     ...
     *
     * @param - none
     * @return <CODE>true</CODE> (if this node is a leaf) or
     ...
     * of each node.
     *
     * @param <CODE>depth</CODE> the depth of this node (with 0 for root, 1 for the root's
     *                           children, and so on)(
